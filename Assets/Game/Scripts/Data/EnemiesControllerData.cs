...
namespace Project
{
    ...
    public class EnemiesControllerData : ScriptableObject
    {
        ...
        [field: SerializeField] public int CountFragments {get; private set; }
        [field: SerializeField] public AngleRange SpreadRange { get; private set; }
        [field: SerializeField] public float FragmentOffset { get; private set; }
